...
import static sa.gov.moe.etraining.http.HttpStatus.ACCEPTED;
import static sa.gov.moe.etraining.http.HttpStatus.UPGRADE_REQUIRED;
import static sa.gov.moe.etraining.http.interceptor.NewVersionBroadcastInterceptor.HEADER_APP_LATEST_VERSION;
import static sa.gov.moe.etraining.http.interceptor.NewVersionBroadcastInterceptor.HEADER_APP_VERSION_LAST_SUPPORTED_DATE;
import static sa.gov.moe.etraining.test.util.TimeUtilsForTests.DEFAULT_TIME;
