...
import sa.gov.moe.etraining.model.course.EncodedVideos;
...
import sa.gov.moe.etraining.view.adapters.CourseUnitPagerAdapter;
import sa.gov.moe.etraining.view.custom.DisableableViewPager;
...
public class CourseUnitNavigationActivityTest extends CourseBaseActivityTest {
    ...
    public static class ParameterizedFragmentCreation extends UiTest {
        ...
        public void test() throws IOException {
            config = new sa.gov.moe.etraining.util.Config(generateConfigProperties());
