...
import sa.gov.moe.etraining.event.LogoutEvent;
...
import sa.gov.moe.etraining.profiles.UserProfileActivity;
import sa.gov.moe.etraining.util.Config;
import sa.gov.moe.etraining.util.EmailUtil;
import sa.gov.moe.etraining.util.SecurityUtil;
import sa.gov.moe.etraining.whatsnew.WhatsNewActivity;
...
public class Router {
    ...
    public void showAboutPage(Activity sourceActivity) {
        Intent settingsIntent = new Intent(sourceActivity, ShowAboutPageActivity.class);
        settingsIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        sourceActivity.startActivity(settingsIntent);
    }

    public void showFAQPage(Activity sourceActivity) {
        Intent settingsIntent = new Intent(sourceActivity, ShowFAQPageActivity.class);
        settingsIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        sourceActivity.startActivity(settingsIntent);
    }

    public void showContactsPage(Activity sourceActivity) {
        Intent settingsIntent = new Intent(sourceActivity, ShowContactsPageActivity.class);
        settingsIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        sourceActivity.startActivity(settingsIntent);
    }
