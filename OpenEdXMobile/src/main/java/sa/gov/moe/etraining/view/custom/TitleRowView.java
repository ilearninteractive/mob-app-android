...
import static sa.gov.moe.etraining.R.color;
import static sa.gov.moe.etraining.R.styleable;
...
public class TitleRowView extends LinearLayout {
    ...
    private void setAttributes(Context context, AttributeSet attrs) {
        ...
        addView(titleView, new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT, 0));
