...
import static sa.gov.moe.etraining.http.HttpStatus.BAD_GATEWAY;
import static sa.gov.moe.etraining.http.HttpStatus.GATEWAY_TIMEOUT;
import static sa.gov.moe.etraining.http.HttpStatus.INTERNAL_SERVER_ERROR;
import static sa.gov.moe.etraining.http.HttpStatus.SERVICE_UNAVAILABLE;
