...
import sa.gov.moe.etraining.databinding.FragmentWebviewCourseDiscoveryBinding;
...
import sa.gov.moe.etraining.event.MainDashboardRefreshEvent;
...
import sa.gov.moe.etraining.model.SubjectModel;
import sa.gov.moe.etraining.module.analytics.Analytics;
import sa.gov.moe.etraining.util.FileUtil;
import sa.gov.moe.etraining.util.ViewAnimationUtil;
import sa.gov.moe.etraining.view.adapters.PopularSubjectsAdapter;

import static sa.gov.moe.etraining.util.UrlUtil.QUERY_PARAM_SEARCH;
import static sa.gov.moe.etraining.util.UrlUtil.QUERY_PARAM_SUBJECT;
import static sa.gov.moe.etraining.util.UrlUtil.buildUrlWithQueryParams;
