package sa.gov.moe.etraining.module.facebook;
 ...
 *
 * This class forwards all the methods calls to {@link UiLifecycleHelper}.
 * However, if during object creation of this class, if Facebook applicationId was not configured, then
 * this class doesn't forward any calls to {@link UiLifecycleHelper}, meaning it does nothing in this case.
 */
