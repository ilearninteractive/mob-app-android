...
import sa.gov.moe.etraining.event.SessionIdRefreshEvent;
...
import sa.gov.moe.etraining.services.EdxCookieManager;
import sa.gov.moe.etraining.util.NetworkUtil;
import sa.gov.moe.etraining.util.WebViewUtil;

import static sa.gov.moe.etraining.util.WebViewUtil.EMPTY_HTML;
