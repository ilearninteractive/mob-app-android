...
import sa.gov.moe.etraining.util.ConfigUtil;
import sa.gov.moe.etraining.util.NetworkUtil;
import sa.gov.moe.etraining.util.StandardCharsets;
import sa.gov.moe.etraining.util.links.EdxCourseInfoLink;
import sa.gov.moe.etraining.util.links.EdxEnrollLink;

/**
 * Created by rohan on 2/2/15.
 * <p/>
 * This class represents a custom {@link WebViewClient}.
 * This class is responsible for setting up a given {@link WebView}, assign itself
 * as a {@link WebViewClient} delegate and to intercept URLs being loaded.
...
public class URLInterceptorWebViewClient extends WebViewClient {
     ...
     * of actions as declared in {@link URLInterceptorWebViewClient.IActionListener}.
     *
     ...
     * calls {@link URLInterceptorWebViewClient.IActionListener#onClickCourseInfo(String)}
     *
     ...
     * calls {@link URLInterceptorWebViewClient.IActionListener#onClickEnroll(String, boolean)}
     *
