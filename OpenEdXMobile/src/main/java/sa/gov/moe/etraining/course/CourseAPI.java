...
import sa.gov.moe.etraining.model.Filter;
import sa.gov.moe.etraining.model.Page;
import sa.gov.moe.etraining.model.api.ChapterModel;
import sa.gov.moe.etraining.model.api.EnrolledCoursesResponse;
import sa.gov.moe.etraining.model.api.IPathNode;
import sa.gov.moe.etraining.model.api.LectureModel;
import sa.gov.moe.etraining.model.api.ProfileModel;
import sa.gov.moe.etraining.model.api.SectionEntry;
import sa.gov.moe.etraining.model.api.SectionItemModel;
import sa.gov.moe.etraining.model.api.SummaryModel;
import sa.gov.moe.etraining.model.api.SyncLastAccessedSubsectionResponse;
import sa.gov.moe.etraining.model.api.TranscriptModel;
import sa.gov.moe.etraining.model.api.VideoResponseModel;
import sa.gov.moe.etraining.model.course.BlockModel;
...
import sa.gov.moe.etraining.model.course.DiscussionData;
import sa.gov.moe.etraining.model.course.HasDownloadEntry;
import sa.gov.moe.etraining.model.course.HtmlBlockModel;
import sa.gov.moe.etraining.model.course.IBlock;
import sa.gov.moe.etraining.model.course.VideoBlockModel;
import sa.gov.moe.etraining.model.course.VideoData;
import sa.gov.moe.etraining.model.course.VideoInfo;
...
import static sa.gov.moe.etraining.http.constants.TimeInterval.HOUR;
