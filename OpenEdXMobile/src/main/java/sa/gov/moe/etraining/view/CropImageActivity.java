...
import sa.gov.moe.etraining.third_party.subscaleview.ImageSource;
import sa.gov.moe.etraining.user.SaveUriToFileTask;
import sa.gov.moe.etraining.view.custom.CropImageView;
