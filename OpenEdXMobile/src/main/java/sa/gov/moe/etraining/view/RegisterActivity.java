...
import sa.gov.moe.etraining.model.api.FormFieldMessageBody;
import sa.gov.moe.etraining.model.api.ProfileModel;
import sa.gov.moe.etraining.model.api.RegisterResponseFieldError;
...
import sa.gov.moe.etraining.module.registration.model.RegistrationDescription;
import sa.gov.moe.etraining.module.registration.model.RegistrationFieldType;
import sa.gov.moe.etraining.module.registration.model.RegistrationFormField;
import sa.gov.moe.etraining.module.registration.view.IRegistrationFieldView;
import sa.gov.moe.etraining.module.registration.view.RegistrationEditTextView;
import sa.gov.moe.etraining.module.registration.view.RegistrationSelectView;
import sa.gov.moe.etraining.social.SocialFactory;
import sa.gov.moe.etraining.social.SocialLoginDelegate;
import sa.gov.moe.etraining.task.RegisterTask;
...
import sa.gov.moe.etraining.view.custom.DividerWithTextView;
...
public class RegisterActivity extends BaseFragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        agreementMessageView.setText(sa.gov.moe.etraining.util.TextUtils.generateLicenseText(getResources(), R.string.by_creating_account));
