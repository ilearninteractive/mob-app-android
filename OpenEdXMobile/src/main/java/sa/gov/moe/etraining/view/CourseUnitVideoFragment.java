...
import sa.gov.moe.etraining.module.db.impl.DatabaseFactory;
import sa.gov.moe.etraining.player.IPlayerEventCallback;
import sa.gov.moe.etraining.player.PlayerFragment;
import sa.gov.moe.etraining.player.TranscriptListener;
...
import sa.gov.moe.etraining.view.adapters.TranscriptAdapter;
...
public class CourseUnitVideoFragment extends CourseUnitFragment
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (playerFragment == null) {
            ...
            final HasComponent hasComponent = (HasComponent)getActivity();
