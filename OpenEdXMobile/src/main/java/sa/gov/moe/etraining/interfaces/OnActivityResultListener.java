...
/**
 * {@link Activity#onActivityResult(int, int, Intent)} is a protected function in the
 * {@link Activity} class. This interface is designed to make it publicly accessible
