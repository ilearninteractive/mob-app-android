...
public class RegistrationFormField {
    ...
    private @SerializedName("restrictions")
    RegistrationRestriction restriction;
    private @SerializedName("errorMessages")
    ...
    private @SerializedName("defaultOption")
    RegistrationOption defaultOption; // may be nil
