...
import sa.gov.moe.etraining.http.constants.ApiConstants.TokenType;
...
import static sa.gov.moe.etraining.http.constants.ApiConstants.URL_MY_USER_INFO;
...
public interface LoginService {
     ...
     * In case of validation errors the response body will be {@link FormFieldMessageBody}.
     */
    @NonNull
    @FormUrlEncoded
