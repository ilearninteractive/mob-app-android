...
import sa.gov.moe.etraining.databinding.RowBulkDownloadBinding;
...
import sa.gov.moe.etraining.module.prefs.VideoPrefs;
import sa.gov.moe.etraining.module.storage.BulkVideosDownloadCancelledEvent;
import sa.gov.moe.etraining.module.storage.BulkVideosDownloadStartedEvent;
import sa.gov.moe.etraining.util.DownloadUtil;
import sa.gov.moe.etraining.util.MemoryUtil;
import sa.gov.moe.etraining.util.NetworkUtil;
import sa.gov.moe.etraining.util.ResourceUtil;
import sa.gov.moe.etraining.view.adapters.CourseOutlineAdapter;
...
public class BulkDownloadFragment extends BaseFragment {
    ...
    private static class CourseVideosStatus implements Parcelable {
        ...
        public static final Creator<CourseVideosStatus> CREATOR = new Creator<BulkDownloadFragment.CourseVideosStatus>() {
            @Override
            public BulkDownloadFragment.CourseVideosStatus createFromParcel(Parcel in) {
                return new BulkDownloadFragment.CourseVideosStatus(in);
            }

            @Override
            public BulkDownloadFragment.CourseVideosStatus[] newArray(int size) {
                return new BulkDownloadFragment.CourseVideosStatus[size];
            }
        };
    }
}
