package sa.gov.moe.etraining.services;
...
import sa.gov.moe.etraining.task.EnqueueDownloadTask;
import sa.gov.moe.etraining.util.MediaConsentUtils;
import sa.gov.moe.etraining.util.MemoryUtil;
import sa.gov.moe.etraining.view.dialog.DownloadSizeExceedDialog;
import sa.gov.moe.etraining.view.dialog.IDialogCallback;

import static sa.gov.moe.etraining.util.DownloadUtil.isDownloadSizeWithinLimit;
